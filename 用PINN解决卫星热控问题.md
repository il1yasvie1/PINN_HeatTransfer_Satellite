...
<img title="" src="file:///C:/Users/Legion/Desktop/ximu/document/README_source/边界热源.gif" alt="边界热源.gif" data-align="center">

此外，太阳辐射在维持卫星温度方面也是一个重要的热源。当卫星位于地球的阴影面时，它会向四周辐射热量，导致温度急剧下降，从而损耗电子元件的寿命。

<img title="" src="file:///C:/Users/Legion/Desktop/ximu/document/README_source/无边界热源.gif" alt="无边界热源.gif" data-align="center">
...
<img title="" src="file:///C:/Users/Legion/Desktop/ximu/document/README_source/init.png" alt="对比.png" width="701" data-align="center">
...
假设我们包括两个目标的多目标优化问题$\min (f_1(x), f_2(x))$，其中，$f_1(x),f_2(x)>0$，利用$\varepsilon$-约束法，可将问题转化为$\min \{f_1(x) :f_2(x)<\varepsilon\}$。在PINN中，我们类比以上过程，设计新的损失函数：

$$
\begin{align*}
    \mathcal{L}_{pde} &= \frac{1}{|\Omega|} \sum_{(x, y, z, t)\in \Omega}  | \rho C_p \partial_t T_{\mathcal{NN}} - k\Delta_{x,y,z} T_{\mathcal{NN}} |^2 \\
    \mathcal{L}_{\Gamma_i} &= \frac{1}{|\Gamma_i|} \sum_{(x, y, z, t) \in \Gamma_i}  |  k\nabla_{x,y,z} T_{\mathcal{NN}} \cdot n - \epsilon \sigma (T_{amb}^4 - T_{\mathcal{NN}}^4) |^2 \\
    \mathcal{L}_{IC} &= \frac{1}{| \Omega_{x,y,z}|} \sum_{(x, y, z) \in \Omega_{x,y,z}} 
max(|  T_{\mathcal{NN}} - T_0|^2 - \varepsilon， 0)
\end{align*}
$$
...
<img title="" src="file:///C:/Users/Legion/Desktop/ximu/document/README_source/train_loss.png" alt="对比1.png" width="732" data-align="center">

可以看到，普通PINN的总损失曲线整体呈先下降，后趋于平稳的趋势；而改进后的PINN很快便趋近于0。

接下来，在训练过程中，我们还记录了在测试集上的误差和百分比训练损失的对比图，由这张图可以验证损失函数的准确性。如下图：

<img title="" src="file:///C:/Users/Legion/Desktop/ximu/document/README_source/loss_error.png" alt="对比2.png" data-align="center" width="670">
...
![anime_pinn.gif](C:\Users\Legion\Desktop\ximu\document\README_source\pinn.gif)
...
<img title="" src="file:///C:/Users/Legion/Desktop/ximu/document/README_source/pinn_mod.gif" alt="anime_pinn_modified.gif" data-align="center">
